...
contract TipJar {
    ...
    mapping(string => uint256) public conversionRates;//转化率

    mapping(address => uint256) public tipPerPerson;//每人小费
    string[] public supportedCurrencies;  // List of supported currencies 支持的货币
