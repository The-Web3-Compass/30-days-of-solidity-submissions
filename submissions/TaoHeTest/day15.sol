...
contract GasEfficientVoting { 
    ...
    */ 
    function createProposal(bytes32 name, uint32 duration) external { 
        ...
        Proposal memory newProposal = Proposal({ 
            ...
            endTime: uint32(block.timestamp) + duration, executed: false 
        }); 
    ...
    */ 
    ...
    function vote(uint8 proposalId) external { 
        ...
        uint256 mask = 1 << proposalId; require((voterData & mask) == 0, "Already voted"); 
    ...
    * @param voter The voter address * @param proposalId The proposal ID 
