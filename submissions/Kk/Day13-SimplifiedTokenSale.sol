...
contract SimplifiedToeknSale is SimpleERC20 {
    ...
    //parent contract has a constructor with parameters, 
    //then in the child contract's constructor,
    //you must explicitly call the parent contract's constructor and pass the corresponding parameters.
    constructor (
