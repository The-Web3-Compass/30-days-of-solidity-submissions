...
contract SimpleFitnessTracker {
    ...
    modifier onlyRegistered() {
        require(userProfiles[msg.sender].haveRegistered, "User not registered");
        _;
    }
    
    function UserRegistration(string memory _name, uint256 _weight) public {
        require(!userProfiles[msg.sender].haveRegistered, "User already registered");
