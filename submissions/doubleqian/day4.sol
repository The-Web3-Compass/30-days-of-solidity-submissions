...
contract Auctionhouse{
    ...
    uint private highestBid;      //Highest bid is private,accessbile via getWinner
    bool public ended;

    mapping(address => uint) public bids;
    address[] public bidders;

    //Initialize the aution with an item and duration
...
function bid(uint amount)external{
    require(block.timestamp < auctionEndTime, "Auction has a already ended.");
