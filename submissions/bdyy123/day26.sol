...
contract NFTMarketplace is ReentrancyGuard {
    ...
    function setFeeRecipient(uint256 _newFee) external onlyOwner {
    ...
    function listNFT(
        ...
        require(royaltyPercent <= 1000, "Royalty percent too high");
    ...
    function buyNFT(address nftAddress, uint256 tokenId) external payable nonReentrant{
        ...
        require(item.isListed, "NotListed");
        require(msg.value == item.price, "Incorret ETH sent");
        require(item.royaltyPercent + marketplaceFeePercent <= 1000, "Combined fees exceeded");
