...
contract EnhancedSimpleEscrow {
    ...
    function cancelAfterTimeout() external {
        ...
        require(state == EscrowState.AWAITING_DELIVERY, "Can't cancel in current state");
    ...
    function cancelMutual() external{
        require(msg.sender == buyer || msg.sender == seller, "Not authorized");
        require(state == EscrowState.AWAITING_DELIVERY || state == EscrowState.AWAITING_PAYMENT, "CAn't cancelled now");
