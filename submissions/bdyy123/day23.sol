...
contract SimpleLending {
    ...
    function withdrawCollateral(uint256 amount) external {
        ...
        require(collateralBalances[msg.sender] - amount >= requiredCollateral, "Withdraw would break collateral ratio");
    ...
    function borrow(uint256 amount) external {
        ...
        uint maxBorrowAmount = (collateralBalances[msg.sender] * collateralFactorBasisPoints) / 10000;
        uint256 currentDebt = calculateInterestAccrued(msg.sender);

        require(currentDebt + amount <= maxBorrowAmount, "Exceeds allowd amount");
