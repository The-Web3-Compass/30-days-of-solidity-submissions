...
contract SimpleStablecoin is ERC20, Ownable, ReentrancyGuard, AccessControl {
    ...
    function mint(uint256 amount) external nonReentrant {
        ...
        uint256 requiredCollateral = (requiredCollateralValueUSD * collateralizationRatio) / (100 * getCurrentPrice());
    ...
    function redeem(uint256 amount) external nonReentrant {
        ...
        uint256 collateralToReturn = (stablecoinValueUSD * 100) / (collateralizationRatio * getCurrentPrice());
