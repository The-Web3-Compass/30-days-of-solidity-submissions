...
//fulfillRandomWords() generate random number
contract FairChainLottery is VRFConsumerBaseV2Plus {
    enum LOTTERY_STATE {OPEN,CLOSE,CALCULATING}
...
*/
    ...
    function enter() public payable{
        require(msg.value >= entryFee,"send more to buy");
        require(lotteryState == LOTTERY_STATE.CLOSE,"u cant ");
