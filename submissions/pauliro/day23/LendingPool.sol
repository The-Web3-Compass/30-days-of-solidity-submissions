...
/*
    ...
    You'll learn how to calculate interest and manage collateral, 
    demonstrating core DeFi concepts. 
...
contract LendingPool {
    ...
    function withdrawCollateral(uint256 _amount) external {
        ...
        require(
            collateralBalances[msg.sender] - _amount >= requiredCollateral,
    ...
    function getMaxBorrowAmount(address _user) external view returns (uint256) {
        return (collateralBalances[_user] * collateralFactorBasisPoints) / 10000;
    }
