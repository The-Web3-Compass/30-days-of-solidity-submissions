...
contract bodyBuilderTracker {
    ...
    function logWorkout(string memory _activityType,uint256 _duration,uint256 _distance) public onlyRegistered {
        ...
        WorkoutActivity memory newWorkout = WorkoutActivity({Type: _activityType,duration: _duration,distance: _distance,timestamp: block.timestamp});
