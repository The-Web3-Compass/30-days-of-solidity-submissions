...
contract SimpleLengding{
    ...
    function calculateInterestAccrued(address user)public view returns(uint256){
        ...
        uint256 interest = (borrowBalances[user]*timeElapsed*interestRateBasisPoints)/(10000 * 365 days);
    ...
    function getMaxBorrowAmount(address user)external view returns (uint256){
        return (collateralBalances[user]*collateralFactorBasisPoints);
    }
