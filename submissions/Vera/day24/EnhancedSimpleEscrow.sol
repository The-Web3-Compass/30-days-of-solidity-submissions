...
contract EnhancedSimpleEscrow {
    ...
    constructor(address _seller, address _arbiter,uint256 _delieryTimeout){
        require(_delieryTimeout>0,"Delivery timeout must be greater than zero");
        seller = _seller;
        arbiter = _arbiter;
        buyer = msg.sender;
        state = EscrowState.AWAITING_PAYMENT;
        deliveryTimeout = _delieryTimeout;
    }
    ...
    function getTimeLeft()external view returns(uint256){
        ...
        return depositTime + deliveryTimeout;
    }
