...
contract SimpleFitnessTracker {
    ...
    event WorkoutLogged(address indexed user, string activityType, uint256 duration, uint256 distance, uint256 timestamp);
    ...
    function logWorkout(
        ...
        if (
            totalDistance[msg.sender] >= 100_000 &&
            totalDistance[msg.sender] - _distance < 100_000
        ) {
