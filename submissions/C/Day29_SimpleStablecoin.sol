...
contract SimpleStablecoin is ERC20, Ownable, ReentrancyGuard, AccessControl {
    ...
    bytes32 public constant PRICE_FEED_MANAGER_POLE = keccak256("PRICE_FEED_MANAGER_POLE");
    ...
    constructor(
        ...
        _grantRole(PRICE_FEED_MANAGER_POLE, _initialOwner);
    }
    ...
    function setPriceFeedContract(address _newPriceFeed) external onlyRole(PRICE_FEED_MANAGER_POLE) {
