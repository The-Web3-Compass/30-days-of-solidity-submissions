...
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";//只要代码里涉及代币转账，本质上必须使用它
...
contract SimpleStablecoin is ERC20, Ownable, ReentrancyGuard, AccessControl {
    ...
    bytes32 public constant PRICE_FEED_MANAGER_ROLE = keccak256("PRICE_FEED_MANAGER_ROLE");//constant意味着这个值一旦部署就永远不会改变
    ...
    function getCurrentPrice() public view returns (uint256) {
        (, int256 price, , , ) = priceFeed.latestRoundData();//返回实际价格
