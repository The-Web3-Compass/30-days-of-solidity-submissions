...
import "@openzeppelin/contracts/token/ERC20/ERC20.sol";// 提供所有标准代币功能
import "@openzeppelin/contracts/access/Ownable.sol";//所有权系统
import "@openzeppelin/contracts/security/ReentrancyGuard.sol";
import "@openzeppelin/contracts/token/ERC20/utils/SafeERC20.sol";
import "@openzeppelin/contracts/access/AccessControl.sol";//允许合约自定义角色
...
contract SimpleStablecoin is ERC20, Ownable, ReentrancyGuard, AccessControl {
    ...
    event Redeemed(address indexed user, uint256 amount, uint256 collateralReturned);//有人将稳定币赎回为抵押品时
    event PriceFeedUpdated(address newPriceFeed);
    event CollateralizationRatioUpdated(uint256 newRatio);//抵押率被更改
