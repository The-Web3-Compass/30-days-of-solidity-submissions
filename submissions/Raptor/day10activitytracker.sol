...
contract SimpleFitnessTracker {
    ...
    function logWorkout(string memory _activityType,uint256 _duration,uint256 _distance)public onlyRegistered{
        ...
        if(totalWorkouts[msg.sender] == 10){
            emit MilestoneAchieved(msg.sender, "10 workouts achieved", block.timestamp);
        }else if(totalWorkouts[msg.sender] == 50){
            emit MilestoneAchieved(msg.sender, "50 workouts achieved", block.timestamp);
        }else if(totalWorkouts[msg.sender] == 100){
            emit MilestoneAchieved(msg.sender, "100 workouts achieved", block.timestamp);
        }
