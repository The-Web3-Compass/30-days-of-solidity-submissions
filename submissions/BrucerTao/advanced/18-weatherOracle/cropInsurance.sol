...
contract CropInsurance is Ownable {
    ...
    function checkRainfallAndClaim() external {
        ...
        (uint80 roundId, uint256 rainfall,,uint256 updatedAt, uint80 answeredInRound) = weatherOracle.latestRoundData();
    ...
    functioin withdraw() external onlyOwner {
        payable(owner()).transfer(address(this).balance);
    }

    receive() external payable {}

    functioin getBalance() public view returns (uint256) {
