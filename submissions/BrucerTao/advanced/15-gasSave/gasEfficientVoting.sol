...
contract GasEfficientVoting {
    ...
    mapping(uint8 => Proposal) public proposals; //使用mapping方便获取，而不是数组

    mapping(address => uint256) private voterRegistry; //按位来记录是否投票过，0表示对0投票，1表示对1投票，总共可以256个
    ...
    function vote(uint8 proposalId) external {
        ...
        require(currentTime >= proposals[proposalId].startTime, "Voting not start");
