...
contract AutomatedMarketMaker is ERC20 {
    ...
    uint256 public reserveA;  //表示代币的数量
    ...
    function removeLiquidity(uint256 liquidityToRemove) external returns (uint256 amountAOut, uint256 amountBOut) {
        require(liquidityToRemove > 0, "liquity to remove must be > 0");
        ...
        amountAOut = liquidityToRemove * reserveA / totalLiquidity; //要返回的代币数量
