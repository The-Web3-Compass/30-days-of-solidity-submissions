...
contract NFTMarketplace is ReentrancyGuard {
    ...
    uint256 public marketplaceFeePercent; //市场费用百分比
    address public feeRecipient;  //费用接收方
    ...
    struct Listing {
        ...
        uint256 tokenId;
        uint256 price;
        address royaltyReceiver; //创作版税接收地址
    ...
    constructor(uint256 _marketplaceFeePercent, address _feeRecipient){
        require(_marketplaceFeePercent <= 1000, "marketplace fee too high (max 100%)");
    ...
    function listNFT(
        ...
        require(!listings[nftAddress][tokenId].isListed, "alreay listed");
