...
contract PreOrderToken is MyToken{
    ...
    _transfer(msg.sender, address(this), totalSupply); // address(this) is contract address; here we transfer depolyer token to contract
    ...
    function buyTokens() public payable{
        ...
        require(msg.value >= minPurchase,"Amount is lower than min purchase");
        require(msg.value <= maxPurchase,"Amount is higher than max purchase");
        uint256 tokenAmount = (msg.value *10**uint256(decimals))/tokenPrice;
        require(balanceOf[address(this)] >= tokenAmount,"Insufficient token balance in contract");
        totalRaised+=msg.value;
        _transfer(address(this),msg.sender,tokenAmount); //contract send token to buyers
...
// don't understand this transfer function
    ...
    function finalizeSale() public payable{
        ...
        require(block.timestamp > saleEndTime,"Sale is not yet over");
        finalized = true;
