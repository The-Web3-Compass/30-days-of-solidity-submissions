...
contract PreOrderToken is SimpleERC20 {
    ...
    function finalizeSale() public payable {
        require(msg.sender == projectOwner,"Only owner can perform this action.");
        ...
        (bool success,) = projectOwner.call{value:address(this).balance}("");//把我（合约）账户里的所有余额，都转给项目发起人 projectOwner。
